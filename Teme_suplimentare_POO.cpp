...
public:
	...
	Farmacist operator++() {
		...
		this->operator+=(100);//am folosit operatorul precendent pentru a adauga o noua luna 
		return copie;
	}
	...
	float& operator[](int i) {
		if (i >= 0 && i <= this->nrLuni) {
			...
			throw new exception();//am lansat o exceptie daca indexul e gresit
		}
	}
...
public:
	void afisareTipClient() {
		cout << "Acesta este client normal online" << endl;
	}
